    ...
    <div className="max-w-full mx-auto p-4 md:p-6 overflow-hidden">
        ...
        <div className="mb-6">
            ...
            <button
                ...
                className={`bg-blue-500 text-white px-4 py-2 rounded w-full md:w-auto ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-600 transition-transform transform hover:scale-105'}`}
                disabled={isLoading}
            >
